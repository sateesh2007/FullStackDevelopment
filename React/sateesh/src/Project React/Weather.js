...
export default function Weather(){
  ...
  return (
    ...
    <div className='col-md-4'>
        <h1><span className='text-danger'></span><br/>
        {date}-{month+1}-{year}</h1>
        </div>
        
        <div className='col-md-4'>
          <h1 style={{color:'aquamarine', textAlign:'start'}}><b>Weather Forecast</b></h1>
          </div>
         <div className='col-md-4'>
          <h4 style={{textAlign:'left',marginTop:'50px'}}>{message}<br/>
